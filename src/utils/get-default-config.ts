...
export const defaultValues = {
  ...
  wattThreshold: 1000,
  kilowattThreshold: 1000,
  megawattThreshold: 1000,
  gigawattThreshold: 1000,
...
export function getDefaultConfig(hass: HomeAssistant): object {
  ...
  return {
    ...
    mw_decimals: defaultValues.megawattDecimals,
    gw_decimals: defaultValues.gigawattDecimals,
    tw_decimals: defaultValues.terawattDecimals,
    ...
    kilowatt_threshold: defaultValues.kilowattThreshold,
    megawatt_threshold: defaultValues.megawattThreshold,
    gigawatt_threshold: defaultValues.gigawattThreshold,
